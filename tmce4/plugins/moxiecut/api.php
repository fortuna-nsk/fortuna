...
$globaldirs = array("images_tmce"=>array("ext"=>"jpg,gif,png,bmp"),
                    "documents_tmce"=>array("ext"=>"doc,xls,pdf,ppt,txt,csv"),
                    "media_tmce"=>array("ext"=>"mp3,wmv,avi,mp4,mov,flv,mkv,mpg"),
                    "other_tmce"=>array("ext"=>"dat,exe,zip,rar,iso"),
                    "downloaded_tmce"=>array("ext"=>""),
              );
